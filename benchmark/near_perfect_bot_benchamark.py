...
#  45804355 function calls (45672435 primitive calls) in 44.596 seconds
#
#  Ordered by: internal time
#  List reduced from 152 to 91 due to restriction <0.6>
#
#  ncalls  tottime  percall  cumtime  percall filename:lineno(function)
#  1509573    6.769    0.000   14.907    0.000 F:\Programs\Python\Tetris\game_client.py:783(CheckValidity)
#  320570    6.732    0.000    6.794    0.000 F:\Programs\Python\Tetris\agents\near_perfect_bot.py:24(GetColHeight)
#  32979    5.578    0.000    5.590    0.000 F:\Programs\Python\Tetris\agents\near_perfect_bot.py:36(_UpdateHoles)
#  1836812    2.978    0.000    2.978    0.000 {method 'reduce' of 'numpy.ufunc' objects}
#  1836812    1.858    0.000    5.544    0.000 C:\Python39\lib\site-packages\numpy\core\fromnumeric.py:69(_wrapreduction)
#  922    1.725    0.002   23.588    0.026 F:\Programs\Python\Tetris\agents\agent.py:138(GetAllPossiblePositions)
#  2202523/2070607    1.423    0.000    9.265    0.000 {built-in method numpy.core._multiarray_umath.implement_array_function}
#  803945    1.377    0.000    4.138    0.000 C:\Python39\lib\copy.py:66(copy)
#  1670761    1.126    0.000    5.853    0.000 C:\Python39\lib\site-packages\numpy\core\fromnumeric.py:2367(all)
#  1607316    0.960    0.000    0.960    0.000 {method 'astype' of 'numpy.ndarray' objects}
#  1670761    0.839    0.000    7.713    0.000 <__array_function__ internals>:2(all)
#  803201    0.780    0.000    1.547    0.000 C:\Python39\lib\copy.py:258(_reconstruct)
#  32979    0.756    0.000    1.861    0.000 F:\Programs\Python\Tetris\game_client.py:603(_PrePutPiece)
#  131916    0.549    0.000    0.606    0.000 F:\Programs\Python\Tetris\game_client.py:292(SetMap)
#  32979    0.511    0.000    2.869    0.000 F:\Programs\Python\Tetris\game_client.py:557(_LineClear)
#  1738474    0.488    0.000    0.488    0.000 {built-in method builtins.getattr}
#  306840    0.482    0.000    1.296    0.000 C:\Python39\lib\queue.py:122(put)
#  97081    0.471    0.000    2.931    0.000 F:\Programs\Python\Tetris\game_client.py:661(_FindFittedPiece)
#  65958    0.460    0.000    0.866    0.000 C:\Python39\lib\site-packages\numpy\lib\function_base.py:4382(delete)
#  1836812    0.447    0.000    0.447    0.000 C:\Python39\lib\site-packages\numpy\core\fromnumeric.py:70(<dictcomp>)
#  803201    0.437    0.000    0.437    0.000 {method '__reduce_ex__' of 'object' objects}
#  306840    0.430    0.000    1.164    0.000 C:\Python39\lib\queue.py:154(get)
#  613680    0.424    0.000    0.704    0.000 C:\Python39\lib\threading.py:351(notify)
#  1000    0.394    0.000   43.948    0.044 F:\Programs\Python\Tetris\agents\near_perfect_bot.py:50(FindBestMove)
#  1509573    0.338    0.000    0.338    0.000 F:\Programs\Python\Tetris\shape.py:157(GetBitMap)
#  112540    0.306    0.000    4.218    0.000 F:\Programs\Python\Tetris\game_client.py:764(Rotate)
#  699242    0.299    0.000    3.843    0.000 F:\Programs\Python\Tetris\shape.py:190(copy)
#  803201    0.259    0.000    0.385    0.000 C:\Python39\lib\copyreg.py:90(__newobj__)
#  2279001    0.242    0.000    0.242    0.000 {built-in method builtins.isinstance}
#  307762    0.227    0.000    0.369    0.000 C:\Python39\lib\queue.py:97(empty)
#  803201    0.220    0.000    0.220    0.000 {method 'update' of 'dict' objects}
#  350284    0.212    0.000    3.788    0.000 F:\Programs\Python\Tetris\agents\agent.py:42(_AtBottom)
#  1670761    0.209    0.000    0.209    0.000 C:\Python39\lib\site-packages\numpy\core\fromnumeric.py:2362(_all_dispatcher)
#  1836812    0.207    0.000    0.207    0.000 {method 'items' of 'dict' objects}
#  613680    0.175    0.000    0.288    0.000 C:\Python39\lib\threading.py:256(__enter__)
#  32057    0.163    0.000    6.958    0.000 F:\Programs\Python\Tetris\agents\near_perfect_bot.py:78(<listcomp>)
#  613680    0.162    0.000    0.280    0.000 C:\Python39\lib\threading.py:271(_is_owned)
#  613680    0.161    0.000    0.224    0.000 C:\Python39\lib\threading.py:259(__exit__)
#  1607146    0.155    0.000    0.155    0.000 {method 'get' of 'dict' objects}
#  433793    0.134    0.000    0.134    0.000 F:\Programs\Python\Tetris\actions.py:12(__init__)
#  34901    0.133    0.000    1.214    0.000 F:\Programs\Python\Tetris\game_client.py:334(copy)
#  614602    0.133    0.000    0.190    0.000 C:\Python39\lib\queue.py:209(_qsize)
#  803201    0.125    0.000    0.125    0.000 {built-in method __new__ of type object at 0x00007FF9A6C25C60}
#  1610253    0.123    0.000    0.123    0.000 {built-in method builtins.len}
#  32979    0.122    0.000    0.334    0.000 F:\Programs\Python\Tetris\game_client.py:514(_AnalyzeElimination)
#  630061    0.122    0.000    0.122    0.000 {method 'acquire' of '_thread.lock' objects}
#  613680    0.113    0.000    0.113    0.000 {method '__enter__' of '_thread.lock' objects}
#  33979    0.109    0.000    0.586    0.000 F:\Programs\Python\Tetris\game_client.py:279(GetMapArea)
#  33979    0.103    0.000    0.894    0.000 F:\Programs\Python\Tetris\game_client.py:508(CheckGameOver)
#  836190    0.102    0.000    0.102    0.000 {built-in method builtins.hasattr}
#  921442    0.099    0.000    0.099    0.000 {method '__exit__' of '_thread.lock' objects}
#  306840    0.097    0.000    0.132    0.000 C:\Python39\lib\queue.py:213(_put)
#  803201    0.093    0.000    0.093    0.000 {built-in method builtins.issubclass}
#  97093    0.091    0.000    1.541    0.000 F:\Programs\Python\Tetris\game_client.py:653(SpawnPiece)
#  306840    0.083    0.000    0.115    0.000 C:\Python39\lib\queue.py:217(_get)
#  97081    0.078    0.000    0.107    0.000 F:\Programs\Python\Tetris\game_client.py:671(_IsJLSTZ)
#  32979    0.071    0.000    3.842    0.000 F:\Programs\Python\Tetris\game_client.py:629(_PostPutPiece)
#  64114    0.066    0.000    0.439    0.000 C:\Python39\lib\site-packages\numpy\core\fromnumeric.py:2123(sum)
#  131916    0.065    0.000    0.065    0.000 {built-in method numpy.asarray}
#  69942    0.061    0.000    0.061    0.000 {built-in method numpy.array}
#  131916    0.057    0.000    0.057    0.000 {method 'copy' of 'numpy.ndarray' objects}
#  67958    0.057    0.000    0.402    0.000 C:\Python39\lib\site-packages\numpy\core\fromnumeric.py:2763(amin)
#  65958    0.055    0.000    0.253    0.000 C:\Python39\lib\site-packages\numpy\core\numeric.py:149(ones)
#  65958    0.054    0.000    0.054    0.000 {built-in method numpy.empty}
#  32979    0.051    0.000    0.071    0.000 C:\Python39\lib\site-packages\numpy\core\shape_base.py:81(atleast_2d)
#  65958    0.046    0.000    0.976    0.000 <__array_function__ internals>:2(delete)
#  65958    0.044    0.000    0.145    0.000 <__array_function__ internals>:2(copyto)
#  32979    0.042    0.000    0.249    0.000 C:\Python39\lib\site-packages\numpy\core\shape_base.py:222(vstack)
#  194011    0.040    0.000    0.040    0.000 F:\Programs\Python\Tetris\shape.py:119(Rotate90)
#  65978    0.038    0.000    0.191    0.000 <__array_function__ internals>:2(concatenate)
#  16369    0.037    0.000    0.517    0.000 F:\Programs\Python\Tetris\game_client.py:416(Move)
#  64114    0.037    0.000    0.519    0.000 <__array_function__ internals>:2(sum)
#  306840    0.035    0.000    0.035    0.000 {method 'append' of 'collections.deque' objects}
#  69802    0.034    0.000    0.152    0.000 <__array_function__ internals>:2(copy)
#  67958    0.034    0.000    0.477    0.000 <__array_function__ internals>:2(amin)
#  306840    0.032    0.000    0.032    0.000 {method 'popleft' of 'collections.deque' objects}
#  32979    0.029    0.000    5.731    0.000 F:\Programs\Python\Tetris\game_client.py:590(PutPiece)
#  175142    0.028    0.000    0.028    0.000 {method 'add' of 'set' objects}
#  33979    0.025    0.000    0.135    0.000 C:\Python39\lib\site-packages\numpy\core\fromnumeric.py:2268(any)
#  32979    0.023    0.000    0.023    0.000 {built-in method numpy.zeros}
#  32979    0.020    0.000    0.318    0.000 <__array_function__ internals>:2(vstack)
#  33979    0.020    0.000    0.205    0.000 <__array_function__ internals>:2(any)
#  63394    0.019    0.000    0.020    0.000 F:\Programs\Python\Tetris\game_client.py:476(_RefreshLockTime)
#  32057    0.019    0.000    0.165    0.000 <__array_function__ internals>:2(dot)
#  69802    0.019    0.000    0.079    0.000 C:\Python39\lib\site-packages\numpy\lib\function_base.py:726(copy)
#  32979    0.017    0.000    0.105    0.000 <__array_function__ internals>:2(atleast_2d)
#  99606    0.014    0.000    0.014    0.000 {method 'append' of 'list' objects}
#  32979    0.013    0.000    0.013    0.000 F:\Programs\Python\Tetris\shape.py:154(GetShape)
#  16447    0.013    0.000    0.580    0.000 F:\Programs\Python\Tetris\game_client.py:384(ProcessAction)
#  34823    0.013    0.000    0.013    0.000 {built-in method builtins.min}
#  32979    0.011    0.000    0.031    0.000 C:\Python39\lib\site-packages\numpy\core\shape_base.py:218(_vhstack_dispatcher)
#
# Process finished with exit code 0
